...
if len(sys.argv) == 5:
    ...
    try:
        ...
        attributes_file = open('C:/Users/cool dude/PycharmProjects/hello/NeuralNetwork/Data/music_train.csv')
        attributes = csv.reader(attributes_file, delimiter=',')

        attributes = process_attributes(attributes)


        labelsFile = open('C:/Users/cool dude/PycharmProjects/hello/NeuralNetwork/Data/music_train_keys.txt', "r")
        labels = parse_train_labels(labelsFile)

        test_file = open('C:/Users/cool dude/PycharmProjects/hello/NeuralNetwork/Data/music_dev.csv')
        testFile = csv.reader(test_file, delimiter=',')
        testFile = process_attributes(testFile)

        inputHiddenWFile = open('C:/Users/cool dude/PycharmProjects/hello/NeuralNetwork/Data/music_weights_1.csv')
        IHWeights = csv.reader(inputHiddenWFile, delimiter=',')

        for weight in IHWeights:
            inputHiddenWeights.append(weight)

        hiddenFinalWFile = open('C:/Users/cool dude/PycharmProjects/hello/NeuralNetwork/Data/music_weights_2.csv')
        ...
        for i in range(iterations):
            loss = adjust_full_weight(attributes, labels, inputHiddenWeights, hiddenFinalWeights)
            if i < 15:
                print (loss / 2)
        ...
        for i in range(iterations):
            ...
            for iterator in range(1, len(attributes)):
                loss2 = loss2 + adjust_weight(attributes[iterator], labels[iterator - 1], inputHiddenWeights2, hiddenFinalWeights2)
            print (loss2 / 2)
